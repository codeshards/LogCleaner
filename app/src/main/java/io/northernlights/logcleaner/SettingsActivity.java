...
public class SettingsActivity extends PreferenceActivity {
    ...
    public static final String KEY_PREF_ENABLE_AT_BOOT_TIME            = "enableCleaningAtBootTime";
    public static final String KEY_PREF_ENABLE_NOTIFICATIONS           = "enable_notifications";
    public static final String KEY_PREF_ENABLE_BOOT_TIME_NOTIFICATIONS = "enable_clean_at_boot_time_notification";
